...
import 'package:restaurantbookingvendor/pages/authentication/forgot_password_page.dart';
import 'package:restaurantbookingvendor/pages/authentication/sign_up_page.dart';
                    ...
                    FirebaseAuth.instance
                      ...
                      if (result.user != null &&
                        ...
                        Firestore.instance
                            ...
                            .get()
                            .then((value) {
                          if (value.data['type'] == UserType.vendor.string) {
                            ...
                            Scaffold.of(c).showSnackBar(SnackBar(
                              behavior: SnackBarBehavior.floating,
                              content: Text(
                                  'You are not an restaurant user. Sign in to your user app to continue.'),
                            ));
